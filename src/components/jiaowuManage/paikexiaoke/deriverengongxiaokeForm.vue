  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/Exportrengongxiaoke",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "人工消课导出.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{ menuID: "243" }).then((res) => {
