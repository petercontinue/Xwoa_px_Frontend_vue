  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/ExportKaoqingliushui",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "考勤流水导出.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{menuID:"248"}).then((res) => {
