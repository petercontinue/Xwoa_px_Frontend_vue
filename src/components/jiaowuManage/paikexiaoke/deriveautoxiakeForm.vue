  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/ExportAutoPage",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "自动消课导出.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("/xwcloud-sys/sys/SystemSetting/GetAllCampusInfoPages",{menuID:"247"}).then((res) => {
