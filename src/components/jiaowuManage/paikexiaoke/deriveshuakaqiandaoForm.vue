  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/Exportshuakaxiaoke",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "刷卡签到签退.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{menuID:"245"}).then((res) => {
