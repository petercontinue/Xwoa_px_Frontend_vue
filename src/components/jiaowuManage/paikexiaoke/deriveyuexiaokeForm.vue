  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/ExportyuexiaokePage",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "余额消课导出.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{menuID:"250"}).then((res) => {
