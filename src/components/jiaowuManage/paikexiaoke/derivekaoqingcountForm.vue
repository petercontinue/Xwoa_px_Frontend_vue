  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-pkxk/paike/paikexiaoke/ExportKaoqingCount",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "考勤统计导出 .xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{menuID:"249"}).then((res) => {
