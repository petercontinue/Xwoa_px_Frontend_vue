<template>
  ...
  >
    ...
    >
      <Row>
        <Col>
          <FormItem label="教师姓名" prop="teacherID">
            <Select v-model="params.teacherID" placeholder="请选择教师姓名">
              <Option
      ...
      this.$refs["addliushuiForm"].validate((valid) => {
        if (valid) {
          axios
            .request({
              method: "get",
              url: "/xwcloud-pkxk/paike/paikexiaoke/ExportTeacherkebiaoList",
              headers: {
                Authorization: "Bearer " + getToken(),
              },
              params: {
                teacherIDs: this.params.teacherID,
            ...
            .then((res) => {
              ...
              link.setAttribute("download", "教师课表信息.xls");
              link.click();
              link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("/xwcloud-caiwu/caiwu/pxtuifeitable/getallStaff",{})
          .then((result) => {
