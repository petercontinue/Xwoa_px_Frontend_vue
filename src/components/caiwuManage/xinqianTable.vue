...
export default {
  ...
  methods: {
    getYejitongbihuanbiData() {
      api.get("xwcloud-caiwu/caiwu/tongji/yejitongbihuanbi/getYejitongbihuanbi",this.params).then((res) => {
