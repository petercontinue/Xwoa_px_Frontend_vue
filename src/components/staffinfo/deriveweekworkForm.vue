<template>
  ...
  >
    ...
    >
      ...
      <FormItem label="日期" prop="joinTime" style="width: 100%">
        <DatePicker
          type="daterange"
  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-sys/sys/StaffManagement/exportweeklogInfos",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "周工作总结.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{ menuID: "534" }).then((res) => {
