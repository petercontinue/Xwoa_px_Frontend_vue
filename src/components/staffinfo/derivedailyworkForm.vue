  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-sys/sys/StaffManagement/exportdailylogInfos",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "工作日志.xls");
          link.click();
          link = null;
  ...
  watch: {
    ...
    show(val) {
      ...
      if (val) {
        ...
        api.get("xwcloud-sys/sys/StaffManagement/GetAllcampus",{ menuID: "533" }).then((res) => {
