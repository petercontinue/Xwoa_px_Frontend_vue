  ...
  methods: {
    ok() {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-sys/sys/StaffManagement/exportstaffBirthInfos",
          headers: {
          ...
          params: {
            ...
            Sbirthday: this.logForm.staffBirth[0],
            Ebirthday: this.logForm.staffBirth[1],
          },
          responseType: "blob",
        })
        .then((res) => {
          ...
          link.setAttribute("download", "员工生日.xls");
          link.click();
          link = null;
