...
export default {
  ...
  methods: {
    getKumukexiaozhanbiData() {
      api.get("xwcloud-caiwu/shujutongji/other/getKumukexiao",this.params).then((res) => {
        //   console.log(res.obj);
        // if(res.obj.length==0){
