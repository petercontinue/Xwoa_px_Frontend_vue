  ...
  <div>
    <Row>
      <Col span="24">
        ...
        <Button type="info" ghost @click="search(2)">本月校区排课统计</Button>
        <Button type="info" ghost @click="search(3)">下月校区排课统计</Button>
        <span>按起止日期查询</span>
        <Date-picker
          v-model="datesoe"
          type="daterange"
...
export default {
  ...
  methods: {
    getCampuspaikePageData() {
      api.get("xwcloud-caiwu/shujutongji/paike/getCampuspaikePage",this.params).then((res) => {
        // console.log(res)
