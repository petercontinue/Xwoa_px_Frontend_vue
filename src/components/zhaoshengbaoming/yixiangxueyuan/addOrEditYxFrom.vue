      ...
      <Row>
        ...
        <Col span="8">
          <FormItem label="电话关系" prop="parentTelRelation">
            <Select v-model="fromYX.parentTelRelation" clearable filterable>
        ...
        <Col span="8">
          <FormItem label="学员电话" prop="stuTel">
            <Input v-model="fromYX.stuTel" placeholder="请输入学员电话"></Input>
          </FormItem>
        </Col>
      </Row>
      <Row>
        <Col span="8">
          <FormItem label="校区" prop="campusID">
            <Select v-model="fromYX.campusID" clearable filterable>
              <Option
        ...
        <Col span="6">
          <FormItem label="年龄段/年级" prop="stuGradeID">
            <Select v-model="fromYX.stuGradeID" clearable filterable>
              <Option
        ...
        >
          <router-link to="/nianjishezhi">设置</router-link>
        </Col>
        <Col span="6">
          <FormItem label="来源途径" prop="yxFromID">
            <Select v-model="fromYX.yxFromID" clearable filterable>
              <Option
        ...
        <Col
          ...
          style="text-align: left; padding-left: 5px; padding-top: 8px"
        >
          <router-link to="/zhaoshengtujing">设置</router-link></Col
        >
      </Row>
      <Row>
        <Col span="8">
          <FormItem label="学员性别" prop="stuSex">
            <Select v-model="fromYX.stuSex" clearable filterable>
        ...
        <Col span="6">
          <FormItem label="意向程度" prop="yxLevelID">
            <Select v-model="fromYX.yxLevelID" clearable filterable>
              <Option
        ...
        <Col
          ...
          style="text-align: left; padding-left: 5px; padding-top: 8px"
        >
          <router-link to="/yixiangcd">设置</router-link>
        </Col>
        <Col span="6">
          <FormItem label="意向科目" prop="yixiangkemu">
            <Select v-model="fromYX.yixiangkemu" clearable filterable>
              <Option
        ...
        <Col
          ...
          style="text-align: left; padding-left: 5px; padding-top: 8px"
        >
          <router-link to="/kemushezhi">设置</router-link>
        </Col>
      </Row>
      <Row>
        <Col span="8">
        ...
        <Col span="8">
          <FormItem label="市场人" prop="yxshichangTeacherID">
            <Select v-model="fromYX.yxshichangTeacherID" clearable filterable>
              <Option
            ...
            <Panel name="diyParamPanel">
              ...
              <p slot="content">
                <Row>
                  <Col
                    span="8"
                    v-for="diyParam in diyShortParam"
                    :key="diyParam.id"
                  >
                    <FormItem
                ...
                <Row>
                  <Col
                    span="8"
                    v-for="diyParam in diySelectParam"
                    :key="diyParam.id"
                  >
                    <FormItem
                      :label="diyParam.stuparamtypename"
                    ...
                    >
                      <Select
                        ...
                        filterable
                        v-model="
                          fromYX['diyParam_' + diyParam.id]['paramValue']
                        "
                      >
                        <Option
                ...
                <Row>
                  <Col
                    span="12"
                    v-for="diyParam in diyLongParam"
                    :key="diyParam.id"
                  >
                    <FormItem
                      :label="diyParam.stuparamtypename"
    ...
    dropDownOptions: function () {
      return (id) => {
        return this.dropDownOptionList.filter((dropDownOption) => {
          return (
            dropDownOption.stuParamTypeId == id && dropDownOption.isShow == 1
          );
        });
      };
    },
    ...
    ok(type) {
      this.$refs.yxForm.validate((valid) => {
        if (valid) {
          ...
          // return;
          api.post("xwcloud-zsbm/yxstu/YixiangStu/addYixiangStuInfo",this.fromYX).then((res) => {
            if (res.success) {
