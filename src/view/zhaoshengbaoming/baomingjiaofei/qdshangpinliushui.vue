  ...
  <div>
    <Row>
      <Alert show-icon style="margin-top: 0px">
        ...
        <Col>
          <span>温馨提示：该页面是学员报名（新签或续费）时购买商品的流水记录；</span>
        </Col>
      </Alert>
    </Row>
...
export default {
  ...
  methods: {
    ...
    getteachSubjectPages() {
      api.get("/xwcloud-zsbm/zsbm/BaoMingJiaoFei/GetQiandanSuppliesPages",{
        size: this.size,
    ...
    deriveExcel(data) {
      ...
      axios
        .request({
          method: "get",
          url: "/xwcloud-zsbm/zsbm/BaoMingJiaoFei/exportqiandanshangpinList",
          headers: {
        ...
        .then((res) => {
          ...
          link.setAttribute("download", "签单商品流水.xls");
          link.click();
          link = null;
