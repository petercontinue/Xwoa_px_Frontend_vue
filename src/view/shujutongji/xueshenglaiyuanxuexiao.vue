...
export default {
  ...
  methods: {
    getOldschoolBiliData() {
      api
        .get("xwcloud-caiwu/shujutongji/oldschool/getOldschoolBili", this.pieparams)
        .then((res) => {
          if (res.code == "Y" && res.success == true) {
            this.pieData = [];
            for (let item in res.obj) {
              if (res.obj[item].oldschoolName == undefined) {
                res.obj[item].oldschoolName = "其他";
              }
              this.pieData.push({
                value: res.obj[item].bili,
                name: res.obj[item].oldschoolName,
              });
            }
    ...
    getOldschoolstuPageData() {
      api
        .get("xwcloud-caiwu/shujutongji/oldschool/getOldschoolstuPage", this.params)
        .then((res) => {
          if (res.code == "Y" && res.success == true) {
