...
import Jiaoshixueyuantongjixiangxi from "../../components/shujutongji/jiaoshixueyuantongjixiangxi.vue";
...
export default {
  ...
  methods: {
    getTeacherStuData() {
      api
        .get("xwcloud-caiwu/shujutongji/renshu/getTeacherStu", this.params)
        .then((res) => {
