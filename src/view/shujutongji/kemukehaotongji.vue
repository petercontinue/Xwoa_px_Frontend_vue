<template>
  <div>
    ...
    <daochukemutongji v-model="showdaochu" :daochutype="2"></daochukemutongji>
  </div>
</template>
<script>
...
import Daochukemutongji from "../../components/shujutongji/daochukemutongji.vue";
...
export default {
  ...
  methods: {
    getKemukehaoPageData() {
      api.get("xwcloud-caiwu/caiwu/tongji/kemushoufei/getKemukehaoPage",this.params).then((res) => {
    ...
    search(type = null) {
      ...
      if (type == 0) {
        ...
        if (this.datesoe) {
          this.params.startDate = toolbox.dateFtt(this.datesoe[0], "yyyy-MM-dd");
